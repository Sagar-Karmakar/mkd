        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-img-top">
                    <img class="img-responsive img-fluid artist-img" class="card-img-top"
            ...
            <div class="col-md-8">
                <div class="card mb-4">
                        <img class="img-fluid card-img-top artist-banner"
                                    ...
                                    @else
                                    src="{{asset('storage/artist/cover_picture/'.$user->cover_picture)}}"
                                    @endif
                        alt="cover picture">
                        @if ($user->user_name === $user_name)
                        ...
                        <div class="card-body">
                                    <div class="d-flex flex-row mt-2">
                                            ...
                                            <div class="about dropdown pl-2 px-lg-4 ">
                                                    <a href="#" class="font-weight-bold"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Add post <i class="fa fa-plus mkd-text pl-2"></i></a>
